                ...
                ">
                            ...
                            <div class="flex flex-col mb-6">
                                ...
                                <input type="number" name="bln_lahir_jenazah"
                                    ...
                                    placeholder="Masukan bulan lahir jenazah" value="{{ old('bln_lahir_jenazah') }}"
                                    min="1" max="12" />
                            ...
                            <div class="flex flex-col mb-6">
                                ...
                                <input type="number" name="umur_jenazah"
                                    ...
                                    placeholder="Masukan umur jenazah" value="{{ old('umur_jenazah') }}"
                                    min="1" />
                                @error('umur_jenazah')
                                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                                @enderror
                ...
                ">
                                ...
                                <div class="flex flex-col mb-6">
                                    ...
                                    <input type="number" name="tgl_mati_jenazah"
                                        ...
                                        placeholder="Masukan tanggal kematian jenazah"
                                        value="{{ old('tgl_mati_jenazah') }}" min="1" max="31" />
                                ...
                                <div class="flex flex-col mb-6">
                                    ...
                                    <input type="number" name="bln_mati_jenazah"
                                        ...
                                        placeholder="Masukan bulan kematian jenazah"
                                        value="{{ old('bln_mati_jenazah') }}" min="1" max="12" />
                                ...
                                <div class="flex flex-col mb-6">
                                    ...
                                    <input type="number" name="thn_mati_jenazah"
                                        ...
                                        placeholder="Masukan tahun kematian jenazah"
                                        value="{{ old('thn_mati_jenazah') }}" min="1960" />
                ...
                ">
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="text" name="nama_ayah_jenazah"
                                            ...
                                            placeholder="Masukan nama ayah jenazah"
                                            value="{{ old('nama_ayah_jenazah') }}" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="tgl_lahir_ayah_jenazah"
                                            ...
                                            value="{{ old('tgl_lahir_ayah_jenazah') }}" min="1" max="31" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="bln_lahir_ayah_jenazah"
                                            ...
                                            placeholder="Masukan bulan lahir ayah"
                                            value="{{ old('bln_lahir_ayah_jenazah') }}" min="1" max="12" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="thn_lahir_ayah_jenazah"
                                            ...
                                            placeholder="Masukan thun lahir ayah"
                                            value="{{ old('thn_lahir_ayah_jenazah') }}" min="1960" />
                ...
                ">
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="text" name="nama_ibu_jenazah"
                                            ...
                                            placeholder="Masukan nama ibu jenazah"
                                            value="{{ old('nama_ibu_jenazah') }}" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="tgl_lahir_ibu_jenazah"
                                            ...
                                            value="{{ old('tgl_lahir_ibu_jenazah') }}" min="1" max="31" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="bln_lahir_ibu_jenazah"
                                            ...
                                            placeholder="Masukan bulan lahir ibu"
                                            value="{{ old('bln_lahir_ibu_jenazah') }}" min="1" max="12" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="thn_lahir_ibu_jenazah"
                                            ...
                                            placeholder="Masukan thun lahir ibu"
                                            value="{{ old('thn_lahir_ibu_jenazah') }}" min="1960" />
                ...
                ">
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="tgl_lahir_pelapor_jenazah"
                                            ...
                                            value="{{ old('tgl_lahir_pelapor_jenazah') }}" min="1"
                                            max="31" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="bln_lahir_pelapor_jenazah"
                                            ...
                                            value="{{ old('bln_lahir_pelapor_jenazah') }}" min="1"
                                            max="12" />
                ...
                ">
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="text" name="nama_saksi1_jenazah"
                                            ...
                                            placeholder="Masukan nama saksi jenazah"
                                            value="{{ old('nama_saksi1_jenazah') }}" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="tgl_lahir_saksi1_jenazah"
                                            ...
                                            value="{{ old('tgl_lahir_saksi1_jenazah') }}" min="1"
                                            max="31" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="bln_lahir_saksi1_jenazah"
                                            ...
                                            value="{{ old('bln_lahir_saksi1_jenazah') }}" min="1"
                                            max="12" />
                ...
                ">
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="tgl_lahir_saksi2_jenazah"
                                            ...
                                            value="{{ old('tgl_lahir_saksi2_jenazah') }}" min="1"
                                            max="31" />
                                    ...
                                    <div class="flex flex-col mb-6">
                                        ...
                                        <input type="number" name="bln_lahir_saksi2_jenazah"
                                            ...
                                            value="{{ old('bln_lahir_saksi2_jenazah') }}" min="1"
                                            max="12" />
